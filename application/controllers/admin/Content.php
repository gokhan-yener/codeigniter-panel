...
class Content extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data = new  stdClass();
        $data->content = 'admin/content/content_list';
    ...
    public function content_add()
    {
        ...
        $data = new stdClass();
        $data->breadcrumb = "admin/inc/breadcrumb";
        $data->content = "admin/content/content_add";
    ...
    public function content_edit($id = 0)
    {
        ...
        $data = new stdClass();
        $data->content = "admin/content/content_update";
        $data->breadcrumb = "admin/inc/breadcrumb";
        $data->category1 = "İçerikler";
    ...
    public function content_update()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            setFlashMessage("danger", validation_errors());
            redirect("admin/content/content_edit/" . $content_id);

...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/admin/_scripts/html5-qrcode.min.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>assets/admin/_scripts/main.js"></script>
<script type="text/javascript">
    $().ready(function () {

        $('#reader').html5_qrcode(function(data){
                $.ajax({
                    url:"<?php base_url()?>auth/checkqr",
                    method:"post",
                    dataType:"json",
                    data:data,
                    success:function (response) {
                        if(response == true){
                            location.href="<?php echo base_url()?>auth/content";
                        }else{
                            $("#response").html("Böyle bir qr kod için kullanıcı mevcut değil");
                        }
                    },
